...
```
unpaywall <command> [arguments] [flags]
```

Run `unpaywall <command> --help` for the full flag list on any command. This
...
per operation you declare in `unpaywall/domain.go`.
