...
Most of these come down to network reality or how unpaywall serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

unpaywall rate-limits like any public site. unpaywall already paces
...
Where a surface is gated, unpaywall reads a cookie or token you supply
...
`unpaywall`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what unpaywall actually did
